...
define( 'SEO_WP_THEME_VERSION', '2.4.6' );
...
function seo_wp_scripts() {
	...
	wp_enqueue_style('materialize.min.css', get_template_directory_uri() . '/assets/css/materialize.min.css', array(), SEO_WP_THEME_VERSION );
