...
<footer id="colophon" class="site-footer page-footer" role="contentinfo" itemscope="" itemtype="http://schema.org/WPFooter">
	...
	<div class="site-info footer-copyright">
		...
		<?php if(get_theme_mod('copyright')) { 
				...
				&copy; <?php echo esc_html(date_i18n( __( 'Y', 'seo-wp' ) ) ); ?> <a href="<?php echo esc_url(home_url()); ?>"><?php echo esc_html(get_bloginfo('name')); ?></a> - Theme By <a href="<?php echo esc_url($author_uri); ?>" target="_blank">WordPress Arena</a>. <?php echo esc_html__('Powered by', 'seo-wp'); ?> <a href="<?php echo esc_url($wordpress_uri); ?>" target="_blank">WordPress.</a>
