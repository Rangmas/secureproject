	...
	function formbuilder_form(
		...
		if ( $show_form ) {
			...
			foreach ( $contact->fields as $field ) {
				...
				if ( $field->field_type != 'address' && $field->field_type != 'price' && $field->field_type != 'website' && $field->field_type != 'checkboxes' && $field->field_type != 'time' && $field->field_type != 'number' && $field->field_type != 'paragraph' && $field->field_type != 'date' && $field->field_type != 'radio' && $field->field_type != 'dropdown' && $field->field_type != 'section_break' && ! ic_string_contains( $field->field_type, 'dropdown' ) ) {
	...
	function formbuilder_raw_fields( $fields, $in_row = 2, $pre_name = '', $field_values = null, $exclude = array() ) {
		...
		foreach ( $fields->fields as $field ) {
			...
			if ( ! in_array( $field->cid, $exclude ) ) {
				...
				if ( $field->field_type != 'paragraph' && $field->field_type != 'date' && $field->field_type != 'radio' && $field->field_type != 'dropdown' && $field->field_type != 'section_break' && ! ic_string_contains( $field->field_type, 'dropdown' ) ) {
					$added   = true;
